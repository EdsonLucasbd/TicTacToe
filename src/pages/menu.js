...
import {start, playerX} from './game/game.js';
...
export default function main() {
  ...
  return(
    <View style={styles.container}>
      ...
      <RectButton style={styles.buttonStyle} onPress={() => {navigation.navigate('Game'), start(playerX)}} >
      ...
      <RectButton style={styles.buttonStyle} onPress={() => BackHandler.exitApp()} >
